 ...
 *
 * Platform-agnostic type definitions for git tools, targets, and operations.
 ...
 * Node's Buffer extends Uint8Array, so this accepts both.
 */
 ...
 * Uses Map<string, BinaryData> for cross-platform compatibility.
 */
export interface StagedCommitData extends StagedCommit {
  /** File contents keyed by sandbox path */
  contents: Map<string, BinaryData>;
}
